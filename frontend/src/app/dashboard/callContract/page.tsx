...
// import { contractIPSphere } from '../../../blockchain/contract';

interface BlockchainInteractionProps { }

const BlockchainInteraction: React.FC<BlockchainInteractionProps> = () => {
    // const [IPSphere, setIPSphere] = useState<Contract | undefined>(undefined);
    ...
    // useEffect(() => {
    //     (async () => {
    //         const contract = await getContract(contractIPSphere);
    //         console.log("IPSphere")
    //         console.log(contract)
    //         if (contract instanceof Contract) {
    //             setIPSphere(contract);
    //         }
    ...
    //         try {
    //             str = "ABC"
    //             console.log("IPSphere Contract: ", IPSphere);
    //             const result = await IPSphere.stringToBytes(str);
    ...
    //         }
    //     } else {
    //         console.error("IPSphere contract is not initialized");
    //         setErrorMessage("IPSphere contract is not initialized");
    //     }
    // };
    ...
    // //     if (IPSphere) {
    // //         try {
    // //             console.log("IPSphere Contract: ")
    // //             console.log(IPSphere)
    // //             const result = await IPSphere.stringToBytes("abc");
    // //             console.log("Result:", result);
    // //         } catch (error) {
    // //             console.error("Error converting string to bytes:", error);
    // //             setErrorMessage(`Error converting string to bytes: ${error.message}`);
    ...
    //     if (IPSphere) {
    //         try {
    //             const result = await IPSphere.bytesToString(bytes);
    //             console.log("Result:", result);
    //         } catch (error) {
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.setIPDetails(await stringToBytes(ipNumber), ipType);
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.tokenizeIP(await stringToBytes(ipNumber));
    //             console.log("Transaction: ", tx);
    //         } catch (error) {
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.updateIPValuationDetails(
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.mintIP(await stringToBytes(ipNumber));
    //             console.log("Transaction: ", tx);
    //         } catch (error) {
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.burnIP(await stringToBytes(ipNumber));
    //             console.log("Transaction: ", tx);
    //         } catch (error) {
    ...
    //     if (IPSphere) {
    //         try {
    //             const details = await IPSphere.viewIPDetails(await stringToBytes(ipNumber));
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.unpause();
    //             console.log("Transaction: ", tx);
    //         } catch (error) {
    ...
    //     if (IPSphere) {
    //         try {
    //             const tx = await IPSphere.withdraw();
    //             console.log("Transaction: ", tx);
    //         } catch (error) {
